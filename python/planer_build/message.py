...
'''The build directory must be different than the source directory. Use the
--build option to specify the build directory.'''
)

platform_build_extra_flags = 'platform.local.txt: replace build.extra_flags with {}'
